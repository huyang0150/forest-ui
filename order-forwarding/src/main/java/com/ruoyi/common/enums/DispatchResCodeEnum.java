...
public enum ChargeBackResCodeEnum {
    TO_BE_ALLOCATE("0000", "成功"),
    ALLOCATED("5000 ", "参数缺失，订单号必传"),
    DELIVERY("5002", "无法查到该订单的省份地市信息"),
    TRANSFER_SUCCESS("5004", "订单不在调度池内,不允许退单"),
    FINISH("5007", "已经分配的订单，请先重回调度再退单"),
    ROLLBACK("5008", "订单编号和订单类型不匹配");
